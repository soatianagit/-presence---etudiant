...
// Traitement du formulaire d'ajout de présence
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($etudiant_id) || empty($status) || empty($date_presence) || empty($heure_debut) || empty($heure_fin) || empty($cours)) {
        ...
        if (!$etudiant) {
            ...
            $stmt = $pdo->prepare("INSERT INTO presences (etudiant_id, etudiant_name, status, date_presence, heure_debut, heure_fin, cours) VALUES (?, ?, ?, ?, ?, ?, ?)");
            
            try {
                $stmt->execute([$etudiant_id, $etudiant['nom_et_prenom'], $status, $date_presence, $heure_debut, $heure_fin, $cours]);
                ...
                $error = "Erreur lors de l'ajout de la présence: " . $e->getMessage();
            }
        }
    }
}
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Ajouter une Présence</h5>
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="cours" name="cours" list="cours_list" required>
